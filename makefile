all :
	g++ --std=c++11 ./logging/logger.cpp ./logging/logger.hpp ./logging/log.hpp ./logging/log.cpp game.hpp game.cpp economic.cpp population.cpp cities.cpp events.cpp main.cpp -lstdthread -lpthread -o game.exe
